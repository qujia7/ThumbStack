...
cmbMap = enmap.read_fits("/gpfs/fs0/project/r/rbond/msyriac/ilc_dr6v3/20230606/hilc_SZ_yy_17000.fits")
...
def run_analysis(nproc = 1, test=False,
                 catpath = "/home/r/rbond/jiaqu/Thumbstack_DESI/"):
    ...
    catname = "full_catalog_Y3_test_swap.txt"
    ...
    estimatorTypes=['tsz_uniformweight'],
